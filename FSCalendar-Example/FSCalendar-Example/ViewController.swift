...
class ViewController: UIViewController {
    ...
    var events: [Date] = [Date() - 86400, Date() + 86400*4, Date() + 86400*2, Date()]
    ...
    func setEvents() {
        ...
        // events
        let myFirstEvent = dfMatter.date(from: "2022-06-06")
        let mySecondEvent = dfMatter.date(from: "2022-06-04")
...
extension ViewController {
    ...
    func configureCell(_ cell: FSCalendarCell?, for date: Date?, at position: FSCalendarMonthPosition) {
        ...
        diyCell.imageView.image = UIImage(named: "11")
